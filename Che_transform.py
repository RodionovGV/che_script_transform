...
list_rules = [
    ...
    # Выражения с условиями
    # "(\S)|(\b)" регулярное выражение скобки две
    (r'(^|[ (])"(\S)', r'\1«\2'), # "\S - левая кавычка
    (r'([\D|\W])"([\S|\s|$])', r'\1»\2'), # \b" - правая кавычка
    (r'"($)', r'»\1'), # \b" - правая кавычка
    #(r'(\D|\W)"([. ),]|\s|\n)', r'\1»\2'), # \b" - правая кавычка
